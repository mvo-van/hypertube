    ...
    <GenericPage>
      ...
      <div className={style.banner} style ={{ backgroundImage: `url(${movie.banner})` }}>
        ...
        <div className={style.movieBox}  >
          ...
          <Comments comments={comments} color={movie.id%12} movieIcon={true}/>
        </div>
      </div>
    </GenericPage>
  );
